...
2. freqtrade trade --logfile ./logs --freqaimodel ReinforcementLearner_multiproc --strategy RL_kdog_futures_custom_stoploss
    ...
    custom_info = {
        ...
        'set_to_break_even_at_profit': set_to_break_even_at_profit,
    }
    ...
    def custom_stoploss(self, pair: str, trade: 'Trade', current_time: datetime,
        ...
        if custom_info_pair is not None:
            ...
            reward_distance = risk_distance*self.custom_info['risk_reward_ratio'].value
            ...
            break_even_profit_distance = risk_distance*self.custom_info['set_to_break_even_at_profit'].value
